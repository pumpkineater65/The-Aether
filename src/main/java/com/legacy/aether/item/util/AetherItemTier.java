...
public class AetherItemTier implements ToolMaterial {
    ...
    public AetherItemTier(int harvestLevel, int maxUses, float efficiencyOnProperMaterial, float damageVsEntity, int enchantability, ItemConvertible repairMaterial) {
