...
import com.legacy.aether.item.food.*;
...
import com.legacy.aether.item.weapon.*;
...
public class ItemsAether {
    ...
    public static void registerItems() {
        ...
        blueberry = register("blueberry", new Item(new Item.Settings().group(AetherItemGroup.AETHER_FOOD).food(AetherFood.DEFAULT)));
        enchanted_blueberry = register("enchanted_blueberry", new Item(new Item.Settings().group(AetherItemGroup.AETHER_FOOD).rarity(Rarity.RARE).food(AetherFood.ENCHANTED_BLUEBERRY)));
        ...
        candy_cane = register("candy_cane", new Item(new Item.Settings().group(AetherItemGroup.AETHER_FOOD).food(AetherFood.DEFAULT)));
        gingerbread_man = register("gingerbread_man", new Item(new Item.Settings().group(AetherItemGroup.AETHER_FOOD).food(AetherFood.DEFAULT)));
