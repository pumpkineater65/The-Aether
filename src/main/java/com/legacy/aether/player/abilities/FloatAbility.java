...
public class FloatAbility implements AetherAbility {
    ...
    public boolean shouldExecute() {
        ...
        return this.playerAether.getAccessoryInventory().wearingAccessory(new ItemStack(ItemsAether.golden_feather)) && !player.isFallFlying() && player.getVelocity().y < 0.0D && !player.isSubmergedInWater() && !player.isSneaking();
    }
