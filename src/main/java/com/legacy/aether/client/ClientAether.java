...
public class ClientAether implements ClientModInitializer {
    ...
    public static int getEffectiveHeight() {
        return MinecraftClient.getInstance().world != null ? (MinecraftClient.getInstance().world.getRegistryKey() == World.NETHER ? 128 : 256) : 0;
    }
    ...
    private void registerItemColors(ItemConvertible... items) {
        AetherColor color = new AetherColor();
