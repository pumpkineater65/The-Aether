...
public class AerbunnyModel extends EntityModel<EntityAerbunny> {
    ...
    @Override
    public void animateModel(EntityAerbunny entity, float f, float g, float h) {
        e = entity;
    }
    ...
    @Override
    public void setAngles(EntityAerbunny e, float f, float f1, float f2, float f3, float f4) {
        this.e = e;
