...
public class SheepuffModel extends QuadrupedEntityModel<EntitySheepuff> {
    ...
    public SheepuffModel(float scale) {
        this(12, scale, false, 10.0F, 4.0F, 2.0F, 2.0F, 24);
    }

    public SheepuffModel(int legHeight, float scale, boolean headScaled, float childHeadYOffset, float childHeadZOffset, float invertedChildHeadScale, float invertedChildBodyScale, int childBodyYOffset) {
    ...
    @Override
    public void setAngles(EntitySheepuff sheepuff, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
