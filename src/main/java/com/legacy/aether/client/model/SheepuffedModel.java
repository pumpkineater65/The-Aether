...
public class SheepuffedModel extends QuadrupedEntityModel<EntitySheepuff> {
    ...
    public SheepuffedModel(int legHeight, float scale, boolean headScaled, float childHeadYOffset, float childHeadZOffset, float invertedChildHeadScale, float invertedChildBodyScale, int childBodyYOffset) {
        ...
        this.torso.addCuboid(-4.0F, -8.0F, -7.0F, 8, 16, 6, 3.75F);
    ...
    @Override
    public void animateModel(EntitySheepuff sheepuff, float limbSwing, float limbDistance, float partialTickTime) {
