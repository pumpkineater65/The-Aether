...
public class FlyingCowWingModel extends EntityModel<EntityFlyingCow> {
    ...
    private EntityFlyingCow entityIn;

    private ModelPart leftWingInner = new ModelPart(this, 0, 0);
    private ModelPart leftWingOuter = new ModelPart(this, 20, 0);
    private ModelPart rightWingInner = new ModelPart(this, 0, 0);
    private ModelPart rightWingOuter = new ModelPart(this, 40, 0);
    ...
    @Override
    public void setAngles(EntityFlyingCow entity, float limbAngle, float limbDistance, float customAngle, float headYaw, float headPitch) {
        entityIn = entity;
    }

    @Override
    public void animateModel(EntityFlyingCow entity, float f, float g, float h) {
        entityIn = entity;
    }
