...
public class ChestMimicModel extends EntityModel<EntityChestMimic> {
    ...
    @Override
    public void setAngles(EntityChestMimic entityIn, float f, float f1, float f2, float f3, float f4) {
