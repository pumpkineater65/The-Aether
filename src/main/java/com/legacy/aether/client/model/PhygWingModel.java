...
public class PhygWingModel extends EntityModel<EntityPhyg> {
    ...
    @Override
    public void animateModel(EntityPhyg entity, float f, float g, float h) {
        phyg = entity;
    }
    ...
    @Override
    public void setAngles(EntityPhyg phyg, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.phyg = phyg;
    }
