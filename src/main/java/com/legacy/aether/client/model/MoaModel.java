...
public class MoaModel extends BipedEntityModel<EntityMoa> {
    ...
    @Override
    public void animateModel(EntityMoa entity, float f, float g, float h) {
        entityIn = entity;
    }
    ...
    @Override
    public void setAngles(EntityMoa moaIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.entityIn = moaIn;
