...
public class FloatingBlockRenderer extends EntityRenderer<EntityFloatingBlock> {
    ...
    @Override
    public void render(EntityFloatingBlock entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
    ...
    @Override
    public Identifier getTexture(EntityFloatingBlock entityIn) {
