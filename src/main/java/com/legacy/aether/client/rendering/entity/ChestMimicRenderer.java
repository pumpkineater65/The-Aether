...
public class ChestMimicRenderer extends MobEntityRenderer<EntityChestMimic, ChestMimicModel> {
    ...
    @Override
    public void render(EntityChestMimic entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
    ...
    @Override
    public Identifier getTexture(EntityChestMimic entity) {
        return null;
    }
