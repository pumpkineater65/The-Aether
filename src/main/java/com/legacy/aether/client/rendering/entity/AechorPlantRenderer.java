...
public class AechorPlantRenderer extends MobEntityRenderer<EntityAechorPlant, AechorPlantModel> {
    ...
    @Override
    protected float getAnimationProgress(EntityAechorPlant livingEntity_1, float float_1) {
        return super.getAnimationProgress(livingEntity_1, float_1);
    }

    @Override
    protected void scale(EntityAechorPlant b1, MatrixStack matrices, float f) {
    ...
    @Override
    public Identifier getTexture(EntityAechorPlant entity) {
        return TEXTURE;
    }
