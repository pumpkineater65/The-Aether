...
public class EntityAerbunny extends EntityAetherAnimal {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (!stack.isEmpty()) {
            ...
            this.world.playSound(this.getX(), this.getY(), this.getZ(), SoundsAether.aerbunny_lift, SoundCategory.NEUTRAL, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F, false);
