...
public class EntityPoisonDart extends EntityDart {
    ...
    public EntityPoisonDart(EntityType<? extends PersistentProjectileEntity> entityType, double x, double y, double z, World world) {
        super(entityType, x, y, z, world);

        this.setDamage(0);
    }

    public EntityPoisonDart(EntityType<? extends PersistentProjectileEntity> entityType, LivingEntity owner, World world) {
        super(entityType, owner, world);

        this.setDamage(0);
    }

    public EntityPoisonDart(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
