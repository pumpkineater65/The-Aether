...
public class BlockIcestone extends Block {
    ...
    public boolean isIn(Tag<Block> tag) {
        return tag == BlockTags.ICE || super.isIn(tag);
    }

    @Override
    public void onBlockAdded(BlockState stateIn, World worldIn, BlockPos posIn, BlockState neighborStateIn, boolean boolIn) {
